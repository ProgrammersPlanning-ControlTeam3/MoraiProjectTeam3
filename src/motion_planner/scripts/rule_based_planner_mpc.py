...
class rule_based_planner:
    def __init__(self):
        ...
        self.mpc = MPCController() # Pure Pursuit control
        ...
        while not rospy.is_shutdown():
            if self.is_path == True and self.is_odom == True and self.is_status == True: # Everything is OK
                ...
                self.current_waypoint = self.mpc.get_current_waypoint(self.status_msg, self.global_path)
