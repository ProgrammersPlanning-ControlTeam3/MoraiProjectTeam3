...
class pure_pursuit_no_npc:
    def __init__(self):
        ...
        self.vehicle_length = 5.155  # Hyeondai Ioniq (hev)
        self.lfd = 10
        self.min_lfd = 10
...
class stanley :
    def __init__(self):
        ...
        self.k_psi=0.6 # For heading Error
        self.k_y=1.4 # For CTR Error
        
        # self.k=1.04 # Stanley Gain
        # self.k_psi=1.1 # For heading Error
        # self.k_y=0.76 # For CTR Error
        '''
    ...
    def calc_stanley_control(self):
            ...
            dx = self.global_path.poses[nearest_idx + 10].pose.position.x - self.global_path.poses[nearest_idx].pose.position.x
            dy = self.global_path.poses[nearest_idx + 10].pose.position.y - self.global_path.poses[nearest_idx].pose.position.y
